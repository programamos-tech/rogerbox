...
async function runMigration() {
  ...
  const SERVICE_ROLE_KEY =
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imxyd2l5cW9kd3pxZGx6a2N6dmdlIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2OTIwNTk5NCwiZXhwIjoyMDg0NzgxOTk0fQ.rrUiT6t4xBwG6LOlQyFmmvPCGtv_acixv82v0twCa9A';
  ...
  console.log(
    '⚠️  El SDK de JS tiene limitaciones para correr scripts DDL masivos directamente.',
  );
  console.log(
    '👉 Ejecutando a través de múltiples llamadas si es necesario o recomendando SQL Editor.',
  );
