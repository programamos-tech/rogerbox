...
export default function LandingPage({ onLogin }: LandingPageProps) {
  ...
  const [_activePlan, _setActivePlan] = useState<'basic' | 'pro'>('basic');
    ...
    try {
      ...
      try {
        ...
        if (error.message?.includes('User already registered')) {
          setRegisterError(
            'Ya tienes una cuenta registrada con este email. Por favor, inicia sesión.',
          );
          return;
        }
      ...
      if (authError) {
        ...
        if (
          ...
          setRegisterError(
            'El formato del email no es válido. Por favor, verifica tu dirección de correo.',
          );
        } else if (
          ...
          setRegisterError(
            'Error de autenticación. Por favor, verifica tus datos.',
          );
        } else if (
          ...
          authError.message.includes('Server error') ||
          ...
          setRegisterError(
            'Error inesperado. Por favor, intenta nuevamente o contacta soporte.',
          );
        }
        return;
      }
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-20">
              ...
              <nav className="hidden md:flex items-center space-x-8">
                <a
                  href="#"
                  className="text-white hover:text-[#85ea10] transition-colors font-semibold border-b-2 border-[#85ea10] pb-1"
                >
                  INICIO
                </a>
                <a
