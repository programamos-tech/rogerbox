...
import { Calendar, CheckCircle, Clock, Flame, QrCode } from 'lucide-react';
...
export default function AttendanceModule() {
  ...
  const getUpcomingReservations = () => {
    ...
    return reservations
      .filter(
        (r) => r.status === 'active' && isAfter(new Date(r.classDate), now),
      )
      .sort(
        (a, b) =>
        ...
        {showSuccess && (
          <div className="mb-6 bg-green-500/20 border border-green-500/30 rounded-lg p-4">
            ...
            <p className="text-green-200 text-sm">
              ...
              <span className="font-bold">{lastCalories} calorías</span> en esta
              clase.
            </p>
          </div>
        )}
        ...
        {upcomingReservations.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="text-gray-300 text-sm">
              Reserva una clase en el calendario para poder registrar tu
              asistencia.
            </p>
          </div>
        ) : (
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    <div>
                      ...
                      <p className="text-gray-300 text-sm">
                        {format(classDate, "EEEE, d 'de' MMMM 'a las' HH:mm", {
                          locale: es,
                        })}
                      </p>
                    </div>
