  ...
  const renderUsers = () => (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="text-white/60">{safeUsers.length} usuarios total</div>
      </div>
                  ...
                  <td className="px-6 py-4">
                    <div className="flex flex-wrap gap-1">
                      {(user.goals || []).slice(0, 2).map((goal, index) => (
                        <span
                          key={index}
                          className="px-2 py-1 bg-[#85ea10]/20 text-[#85ea10] rounded-full text-xs"
                        >
                          {goal}
                        </span>
                      ))}
            ...
            <div className="flex items-center justify-between h-16">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-white/60 text-sm">
                    RogerBox - Gestión de Plataforma
                  </p>
                </div>
              </div>
              <div className="text-white/60 text-sm">Bienvenido, Roger</div>
            </div>
          </div>
        </div>
