...
const GymPaymentsManagement = forwardRef<GymPaymentsManagementRef>(
  (_props, ref) => {
    ...
    const [_expiredMembershipToPay, setExpiredMembershipToPay] =
      useState<any>(null);
    ...
    }, [showForm, clients.length, loadData]);
    ...
    }, [selectedPlan?.id, selectedPlan, formData.period_start]);
