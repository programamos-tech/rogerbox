...
export default function GoalSuggestionCard({
  ...
  const getInitialCardState = (): 'initial' | 'viewed' | 'dismissed' => {
    ...
    const hasViewedRecommendedCourse = localStorage.getItem(
      'hasViewedRecommendedCourse',
    );
    const hasDismissedGoalSuggestion = localStorage.getItem(
      'hasDismissedGoalSuggestion',
    );
    const lastGoalSuggestionShown = localStorage.getItem(
      'lastGoalSuggestionShown',
    );
  ...
  const _handleAcceptChallenge = () => {
    ...
    const currentCount = parseInt(
      localStorage.getItem('goalSuggestionCount') || '0',
      10,
    );
  ...
  const findBestCourse = () => {
    ...
    let bestCourse = availableCourses.find(
      (course) =>
  ...
  const _bmiColors = getBMIColor(userBMI);
        ...
        <div className="relative z-10">
              ...
              <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 border-l-4 border-green-500">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      Meta sugerida:{' '}
                      <strong>{suggestion.weightLossGoal} kg menos</strong>
                    </p>
                  </div>
                  <button
          ...
          <div className="mb-6 pr-32">
            ...
            <Link
              href={
                bestCourse
                  ? `/course/${bestCourse.slug}`
                  : getCoursePath(suggestion.recommendedCourse)
              }
            ...
            >
              ...
              <div className="relative w-20 h-20 flex-shrink-0 overflow-hidden rounded-lg">
                ...
                <div className="absolute top-1 right-1">
                  <div
                    className={`px-1.5 py-0.5 rounded-full text-xs font-bold ${getDifficultyColor(suggestion.difficulty)} bg-white/90`}
                  >
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            >
              ...
              <span>
                {cardState === 'viewed' ? 'Comprar Ahora' : '¡Acepto el Reto!'}
              </span>
            </button>
            ...
            <div className="p-6">
              ...
              <div className="mb-6">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300">
                  ...
                  tu peso con tu altura. Es una herramienta útil para evaluar si
                  tu peso está en un rango saludable.
                </p>
              </div>
