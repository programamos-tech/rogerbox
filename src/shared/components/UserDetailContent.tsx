                ...
                {chartData.length > 0 &&
                  (() => {
                    const amounts = chartData.map(
                      (d: { amount: number }) => Number(d.amount),
                    );
                    ...
                    <div className="space-y-3">
                              ...
                              <div className="flex items-center gap-3 mb-3">
                                ...
                                <div className="flex-1">
                                  ...
                                  <div className="space-y-1">
                                    <div className="flex items-center gap-2">
                                      {!isSelf && editingStartDateMembershipId ===
                                      membership.id ? (
                      ...
                      {hasActiveCourses && (
                        <div className="space-y-3">
                          ...
                          {userData.activeCoursePurchases.map((purchase: any) => (
                            <div
                              key={purchase.id}
                            ...
                            >
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <div className="mt-1 flex flex-wrap items-center gap-x-3 gap-y-0.5 text-xs text-gray-500 dark:text-white/50">
                                  ...
                                  {purchase.purchase_price != null && Number(purchase.purchase_price) > 0 && (
                                    <span>
                                      ${Number(purchase.purchase_price).toLocaleString('es-CO')}
                                    </span>
                                  )}
                                </div>
                                {isSelf && (
                          ...
                          return (
                            ...
                            >
                                ...
                                <div className="flex-1">
                                  <div className="flex items-center justify-between mb-1">
                                    ...
                                    <div className="flex items-center gap-2">
                                      ...
                                      {!isSelf && membership.status !== 'cancelled' && (
                                        <button
                                          onClick={() =>
                                            openCancelMembershipModal(
                                              membership,
                              ...
                              <div className="mt-3 pt-3 border-t border-gray-200 dark:border-white/10 space-y-2">
                                ...
                                {!isSelf && (userData.whatsapp || userData.phone) ? (
                                  (() => {
                                    const planName =
